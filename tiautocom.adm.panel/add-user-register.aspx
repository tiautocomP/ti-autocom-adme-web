<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-user-register.aspx.cs" Inherits="tiautocom.adm.panel.add_user_register" %>
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        <p class="text-muted">Cadastre o tipo do nivel que o novo usário cadasatrado poderar trabalhar no sistema.</p>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <span class="span" role="alert" id="span-user-cpmapny" aria-hidden="true"></span>
                                        </div>
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="email" id="input-user-email" name="input-user-email" class="form-control" placeholder="ex: abc@gmail.com">
                                            <span class="span" role="alert" id="span-user-email" aria-hidden="true"></span>
