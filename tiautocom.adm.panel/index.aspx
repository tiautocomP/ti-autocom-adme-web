<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="tiautocom.adm.panel.index" %>
...
<head>
	...
	<script src="scripts/protect-index.js"></script>
</head>
					...
					<div class="col-12">
						...
						<div class="mb-2 align-items-center">
							<div class="card shadow mb-4">
								<div class="card-body">
									<p class="mb-1 small text-muted">Balanço geral do sistema</p>
									<div class="row mt-1 align-items-center">

										<%--          <div class="col-12 col-lg-4 text-left pl-4">
                                            <p class="mb-1 small text-muted">Balanço do sistema</p>
										...
										<div class="col-6 col-lg-2 text-center py-4">
											<p class="mb-1 small text-muted">Importação</p>
											<span class="h3">000</span><br />
											<%--	<span class="small text-muted">+20%</span>--%>
										<%--	<span class="fe fe-arrow-up text-success fe-12"></span>--%>
										</div>
										<div class="col-6 col-lg-2 text-center py-4 mb-2">
											<p class="mb-1 small text-muted">Empresa Cadastrado</p>
											<span class="h3">000</span><br />
											<%--		<span class="small text-muted">+6%</span>--%>
											<%--<span class="fe fe-arrow-up text-success fe-12"></span>--%>
										</div>
										<div class="col-6 col-lg-2 text-center py-4">
											<p class="mb-1 small text-muted">Usuários</p>
											<span class="h3">3</span><br />
											<%--					<span class="small text-muted">+20%</span>--%>
											<%--						<span class="fe fe-arrow-up text-success fe-12"></span>--%>
										</div>
										<div class="col-6 col-lg-2 text-center py-4">
											<p class="mb-1 small text-muted">Produtos</p>
											<span class="h3">1300</span><br />
									...
									<div class="card-body" data-simplebar style="height: 355px; overflow-y: auto; overflow-x: hidden;">
										...
										<div class="pb-3 timeline-item item-warning">
											<div class="pl-5">
												...
												<div class="row mb-3">
													<div class="col">
														<img src="./assets/products/p1.jpg" alt="..." class="img-fluid rounded">
													</div>
													<div class="col">
														<img src="./assets/products/p2.jpg" alt="..." class="img-fluid rounded">
													</div>
													<div class="col">
														<img src="./assets/products/p3.jpg" alt="..." class="img-fluid rounded">
													</div>
													<div class="col">
												...
												<p class="small text-muted">
													Front-End Development <span class="badge badge-light">1h ago</span>
												</p>
											</div>
										</div>
										<div class="pb-3 timeline-item item-success">
											<div class="pl-5">
												...
												<p class="small text-muted">
													Back-End Development <span class="badge badge-light">1h ago</span>
												</p>
											</div>
										</div>
