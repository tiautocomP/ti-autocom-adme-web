<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="input-product-list.aspx.cs" Inherits="tiautocom.adm.panel.input_product_list" %>
			...
			<div class="container-fluid">
				<div class="row justify-content-center">
					<div class="col-12">
						...
						<hr />
						<h2 class="h3 mb-3 page-title">Lista de Entrada Produtos</h2>
						<div class="row mb-4 items-align-center">
							...
							<div class="col-md-auto ml-auto text-right">
								...
								<button type="button" class="btn" onclick="location.href='input-product-list.aspx';"><span class="fe fe-refresh-ccw fe-16 text-muted"></span></button>
							</div>
						</div>
