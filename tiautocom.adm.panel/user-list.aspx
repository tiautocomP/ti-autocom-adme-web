<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user-list.aspx.cs" Inherits="tiautocom.adm.panel.type_user_list" %>
			...
			<div class="container-fluid">
				<div class="row justify-content-center">
					<div class="col-12">
						...
						<hr />
						<h2 class="h3 mb-3 page-title">Lista de Usuários</h2>
						<div class="row mb-4 items-align-center">
							...
							<div class="col-md-auto ml-auto text-right">
								...
								<button type="button" class="btn" onclick="location.href='user-list.aspx';"><span class="fe fe-refresh-ccw fe-16 text-muted"></span></button>
							</div>
						</div>
						<!-- Slide Modal -->
								...
								<form class="needs-validation" novalidate>
									...
									<div class="form-row">
										<div class="col-md-1 mb-3">
											<label for="input-id">C´digo</label>
											<input type="text" id="input-id" class="form-control" readonly="readonly">
										</div>

										<div class="col-md-11 mb-3">
											<label for="input-name-razo">Nome do Usuário</label>
											<input type="text" id="input-name-razor" class="form-control">
										</div>
										...
										<div class="col-md-3 mb-3">
											<label for="input-regitre-date">Data de Cadastro</label>
											<input type="text" id="input-regitre-date" class="form-control" readonly="readonly">
										</div>

										<div class="col-md-6 mb-3">
											<label for="select-user-type">Tipo de Usuário</label>
											<div id="select-user-type"></div>
										</div>
										<div class="col-md-3 mb-3">
											<div class="card shadow">
												<div class="card-body">
													<p class="mb-2"><strong>Status Usuário</strong></p>
